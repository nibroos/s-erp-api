...
type InvoiceMaintenanceDt struct {
	gorm.Model
	ID                   uint             `json:"id" gorm:"column:id;primaryKey;autoIncrement"`
	ProductUuid          string           `json:"product_uuid" gorm:"column:product_uuid"`
	InvoiceMaintenanceID *uint            `json:"invoice_maintenance_id" gorm:"column:invoice_maintenance_id"`
...
func (InvoiceMaintenanceDt) TableName() string {
	return "invoice_maintenance_dts"
}
