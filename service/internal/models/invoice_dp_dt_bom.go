...
type InvoiceDpDtBom struct {
	...
	InvoiceDpDtID *uint            `json:"invoice_dp_dt_id" gorm:"column:invoice_dp_dt_id"`
...
func (InvoiceDpDtBom) TableName() string {
	return "invoice_dp_dt_boms"
}
