...
CREATE INDEX idx_sales_invoices_payment_term_id ON sales_invoices(payment_term_id);

CREATE INDEX idx_sales_invoices_vat_id ON sales_invoices(vat_id);

CREATE INDEX idx_sales_invoices_pph23_id ON sales_invoices(pph23_id);
