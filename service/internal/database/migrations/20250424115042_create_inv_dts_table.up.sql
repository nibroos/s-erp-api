CREATE TABLE IF NOT EXISTS inv_dts (
  ...
  ref_so_dt_id BIGINT REFERENCES so_dts(id) ON DELETE RESTRICT,
  ref_so_dt_bom_id BIGINT REFERENCES so_dt_boms(id) ON DELETE RESTRICT,
  ref_po_dt_id BIGINT,
  ref_po_dt_bom_id BIGINT,
  ref_inv_dt_id BIGINT,
