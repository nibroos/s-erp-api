...
type InvoiceMaintenanceUpdateRequest struct {
}

func NewInvoiceMaintenanceUpdateRequest() *InvoiceMaintenanceUpdateRequest {
	return &InvoiceMaintenanceUpdateRequest{}
}

func (r *InvoiceMaintenanceUpdateRequest) Validate(req *dtos.UpdateInvoiceMaintenanceRequest, ctx *fiber.Ctx) (map[string][]string, bool) {
	rules := map[string][]string{
		"id":                                   []string{"required", "exists:invoice_maintenances,id"},
