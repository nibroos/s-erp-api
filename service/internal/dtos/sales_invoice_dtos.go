...
type CreateSalesInvoiceDtRequest struct {
...
type CreateSalesInvoiceRequest struct {
	...
	SalesInvoiceDts          []CreateSalesInvoiceDtRequest `json:"sales_invoice_dts"`
}

type UpdateSalesInvoiceDtRequest struct {
	ID               *uint    `json:"id"`
	SalesInvoiceDtID *uint    `json:"sales_invoice_dt_id"`
	ProductUuid      string   `json:"product_uuid"`
...
type UpdateSalesInvoiceRequest struct {
	...
	TotalVat                 *float64                      `json:"total_vat"`
	GrandTotal               *float64                      `json:"grand_total"`
	SalesInvoiceDts          []UpdateSalesInvoiceDtRequest `json:"sales_invoice_dts"`
}

type GetSalesInvoiceByIDRequest struct {
	ID uint `json:"id"`
}

type GetSalesInvoiceParams struct {
	ID        uint
	IsDeleted *int
}

func NewGetSalesInvoiceParams(id uint) *GetSalesInvoiceParams {
	defaultIsDeleted := 0
	return &GetSalesInvoiceParams{
		ID:        id,
		IsDeleted: &defaultIsDeleted,
	}
}

type GetSalesInvoiceDtParams struct {
	ID             uint
	SalesInvoiceID uint
	IsDeleted      *int
}
...
type SalesInvoiceListDTO struct {
	ID                       int      `json:"id" db:"id"`
	SalesInvoiceID           *uint    `json:"sales_invoice_id" db:"sales_invoice_id"`
...
type SalesInvoiceDetailDTO struct {
	...
	UpdatedAt       *string                 `json:"updated_at" db:"updated_at"`
	DeleteAt        *string                 `json:"deleted_at" db:"deleted_at"`
	SalesInvoiceDts []SalesInvoiceDtListDTO `json:"sales_invoice_dts"`
...
type SalesInvoiceDtListDTO struct {
	ID               *uint    `json:"id" db:"id"`
	SalesInvoiceDtID *uint    `json:"sales_invoice_dt_id" db:"sales_invoice_dt_id"`
...
type GetSalesInvoicesResult struct {
	SalesInvoices []SalesInvoiceListDTO
	Total         int
	Err           error
}
...
type RefSalesOrderForInvoiceListDTO struct {
	ID               *uint     `json:"id" db:"id"`
...
type SalesInvoicePDFData struct {
	Num  string                `json:"num"`
	Form SalesInvoiceDetailDTO `json:"form"`
}
