...
func (c *SeederController) RunSeeders(ctx *fiber.Ctx) error {
	...
	seedFiles := []string{
		...
		"20250206045661_create_branches_seeder.sql",
		"20250206045664_create_mix_values_customer_types_seeder.sql",
		"20250206045662_create_mix_values_pph23s_seeder.sql",
		...
		"20250206045668_create_products_seeder.sql",
		...
		"20250304100358_create_mix_values_shipping_terms_seeder.sql",
		"20250304101512_create_mix_values_payment_terms_seeder.sql",
		"20250304101919_create_mix_values_purchase_types_seeder.sql",
		"20250306120206_create_mix_values_ingoing_outgoing_types_seeder.sql",
		"20250312092648_create_mix_values_warehouse_seeder.sql",
		"20250312092649_create_mix_values_tasks_seeder.sql",
		"20250312092650_create_roles_values_seeder.sql",
		"20250312092650_create_users_seeder.sql",
	}
